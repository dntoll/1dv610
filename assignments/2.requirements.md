...
[Test Application](http://csquiz.lnu.se:25081/index.php "Application To test requirements on"). This is an example solution for assignment 2. It fulfills all the test-cases above.
 ...
 * [Test Application With startup code](http://csquiz.lnu.se:25082/index.php "Application With startup code running"). This is an deployment of the startup code, it should not fulfill so much of the requirements.
